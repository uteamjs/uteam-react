...
(function () {
  ...
  const fileName = "form_form_c5f98842-5fb7-4000-bfbe-75abdea6fb15";
  const element = document.querySelector("style[data-sass-component='form_form_c5f98842-5fb7-4000-bfbe-75abdea6fb15']");
  if (!element) {
...
class utform extends _react.Component {
  constructor(...args) {
    ...
    this.fieldOnBlur = () => true;
    this.onBlur = (0, _field.onBlur)(this);
