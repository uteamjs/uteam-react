...
(function () {
  ...
  const fileName = "form_form_facfe535-a447-4434-bd1a-7d4672b6a78f";
  const element = document.querySelector("style[data-sass-component='form_form_facfe535-a447-4434-bd1a-7d4672b6a78f']");
  if (!element) {
