...
const SingleDate = ({
  ...
  const handleRawChange = e => {
    ...
    if (newValue) {
      ...
      if ((0, _dateFns.isValid)(parsedDate) && parsedDate.getFullYear() > 9999) {
  ...
  const handleBlur = e => {
    ...
    } else if (!(0, _dateFns.isValid)(parsed) || parsed.getFullYear() > 9999) {
  ...
  inputValue === '' && value && setInputValue((0, _dateFns.format)(value, dateFormat));
