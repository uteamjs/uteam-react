...
const onChange = _this => ({
  ...
  let val = type === 'toggle' ? e.target.checked : type === 'checkbox' ? _f.value : e.target.value; //console.log(id, val)
...
const utfield = _this => props => {
  ...
  const _labelPostion = labelPosition ? labelPosition === 'top' ? _reactBootstrap.Col : labelPosition === 'none' ? 'none' : _reactBootstrap.Row : _.isRow === true ? _reactBootstrap.Row : _.isRow === false ? _reactBootstrap.Col : _.isRow;
  ...
  let [w1, w2] = labelWidth || _.labelWidth[no - 1]; //const param = { id, index, children, elem, st, append, isRead: readOnly, onKeyPress }
  ...
  return _labelPostion === 'none' ? /*#__PURE__*/_react.default.createElement(Group, _group, _this.Control(param)) : _labelPostion == _reactBootstrap.Row ? /*#__PURE__*/_react.default.createElement(Group, (0, _extends2.default)({}, _group, {
