...
const reduceDate = {
  ...
  actions: {
    pickDate: (state, {
      ...
      const _f = (0, _util.getField)(state, id, index); //console.log(day.getDay())
    ...
    selectDate: (state, {
      ...
      const _f = (0, _util.getField)(state, id, index); //const value = _f.value || new Date()
    ...
    toggleDate: (state, {
      ...
      _f.isDatePicker = !_f.isDatePicker; //state.isDatePicker[k] =
...
const utInputDate = _this => ({
  ...
  const listMonth = [..._listMonth]; //console.log(typeof (index))
  ...
  }, "X"), /*#__PURE__*/_react.default.createElement(_reactBootstrap.OverlayTrigger, {
    trigger: "click",
