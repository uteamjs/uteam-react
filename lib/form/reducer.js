...
exports.utReducer = void 0;

var _extends2 = _interopRequireDefault(require("@babel/runtime/helpers/extends"));

var _react = require("@uteamjs/react");
...
const initFields = state => state.fieldList = loop(null, state.fields, (parent, key, link) => {
  link.label = link.label || (0, _react.capitalize)(key);
...
const utReducer = (name, o) => {
  const obj = (0, _react.merge)((0, _react.merge)({
    name,
    init: {
      isEdit: true,
      isEditSection: {},
    ...
    actions: (0, _extends2.default)({}, _control.utControlActions, _multiEdit.utMultiAction, _section.utSectionActions, {
      ...
      errorMessage: (state, {
        ...
        const _f = (0, _.getField)(state, id, index);
