  ...
  change: (state, {
    ...
    if (_f.type === 'select' && _f.format) {
      ...
      if (m && parseInt(m[1]) > 1 && m[2] === 'True') {
        // Multiple select
        if ((0, _lodash.isString)(_f.value)) _f.value = [..._f.value.split(',')];
        if (_f.value.length > 0 && typeof _f.value[0] === 'number') val = parseInt(val);
    ...
    case 'select':
      ...
      if (_f.format) {
        ...
        if (_i > 1) {
          ...
          }, (0, _lodash.isArray)(lst) ? lst.map(([key, choice], i) => /*#__PURE__*/_react.default.createElement("option", {
            key: key + '-' + i,
            value: key
          }, choice)) : lst ? Object.entries(lst).map(([key, choice], i) => /*#__PURE__*/_react.default.createElement("option", {
            key: key + '-' + i,
            value: key
          }, choice)) : null);
        }
      ...
      }, lst ? Object.entries(lst).map(([key, choice], i) => /*#__PURE__*/_react.default.createElement("option", {
        key: key + '-' + i,
        value: key
      }, choice)) : null);
    case 'datepicker':
