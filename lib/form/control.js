...
const utControl = _this => props => {
  var _newList4, _v$pattern, _prop$style, _props$style;
  const {
    InputDate
  } = _this;
  //**
  ...
  let {
    ...
    allowNegative,
    align,
    showTextFieldBKColor,
    noAutoWidth,
    onBlur,
    // align only for numeric
    onChange,
    onKeyDown,
    onKeyPress,
    append
  ...
  const _align = (0, _lodash.isUndefined)(align) ? _f.align : align;
  const _allowNegative = (0, _lodash.isUndefined)(allowNegative) ? _f.allowNegative : allowNegative;
  const _showTextFieldBKColor = (0, _lodash.isUndefined)(showTextFieldBKColor) ? _f.showTextFieldBKColor : showTextFieldBKColor;
  ...
  switch (type) {
    ...
    case 'select':
      ...
      if (_f.format) {
        ...
        if (_i > 1) {
          ...
          if (_isRead && !(0, _lodash.isNil)(value) && !(0, _lodash.isEmpty)(value)) {
          ...
          return _isRead ? /*#__PURE__*/_react.default.createElement("div", {
            style: style
          }, optionList(_val)) : /*#__PURE__*/_react.default.createElement("select", {
            id: _elem_id,
            multiple: "multiple",
    ...
    case 'numeric':
      ...
      const v = _f == null ? void 0 : _f.valid;
      if ((v == null ? void 0 : v.min) >= 0) {
        _prop.allowNegative = false;
      } else if ((v == null ? void 0 : v.min) < 0 || (v == null ? void 0 : v.max) < 0) {
      ...
      const matchDec = v == null || (_v$pattern = v.pattern) == null ? void 0 : _v$pattern.match(/numeric field with at most (\d+) decimal/);
    ...
    case 'textarea':
      ...
      // if (_isRead)
      if (_isRead && type != 'textarea' && type != 'text') return /*#__PURE__*/_react.default.createElement("div", {
        "aria-label": _f.label
      }, value);
      if (_isRead && type == 'text' && !_showTextFieldBKColor) return /*#__PURE__*/_react.default.createElement("div", {
        "aria-label": _f.label
      }, value);
      delete props.isRead;
