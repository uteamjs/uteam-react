...
const utControl = _this => props => {
  ...
  switch (type) {
    ...
    case 'radio':
      if (_isRead) return /*#__PURE__*/_react.default.createElement("div", null, list[value]);

    case 'checkbox':
      return /*#__PURE__*/_react.default.createElement("div", null, list ? Object.entries(list).map(([key, choice], i) => /*#__PURE__*/_react.default.createElement(_reactBootstrap.Form.Check, {
        inline: true,
        disabled: _isRead,
