...
const utControl = _this => props => {
  var _f$valid, _f$valid2, _f$valid3, _f$valid4, _prop$style, _props$style;
  const {
    InputDate
  } = _this;
  //**
  ...
  switch (type) {
    ...
    case 'checkbox':
      ...
      if (_sortListBy && rules != null && rules.length) {
        ...
        if (rules.length >= 2) {
          if (rules[1] === 'skipHyphens') {
            newList = newList.filter(t => !/^[-]+$/.test(t == null ? void 0 : t[1]));
          } else {
            console.log("Warn: Checkbox sortListby " & rules[1] & "not valid");
          }
        }
        if (rules[0] === 'key') {
          newList = newList.sort((a, b) => a == null ? void 0 : a[0].localeCompare(b == null ? void 0 : b[0]));
        } else if (rules[0] === 'value') {
          newList = newList.sort((a, b) => a == null ? void 0 : a[1].localeCompare(b == null ? void 0 : b[1]));
        } else {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        "aria-label": _f.label
      }, newList.map(([key, choice], i) => /*#__PURE__*/_react.default.createElement(_reactBootstrap.Form.Check, {
        inline: true,
        disabled: _isRead,
        checked: value && value.split('|').indexOf(key) >= 0,
        style: {
      ...
      if (_f.format) {
        ...
        if (_l >= 2) {
          ...
          if (_l >= 3) {
            ...
            numWidth = numWidth + Math.trunc((numWidth - ((matchDec == null ? void 0 : matchDec[1]) || 0) - 0.1) / 3); // parseInt(_n[2]) not always show decimal places in program codes
